  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.ogtechnologies.co/careers" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.ogtechnologies.co/careers" />
        ...
        <meta name="twitter:url" content="https://www.ogtechnologies.co/careers" />
