...
const SECTIONS = [
  ...
  { key: 'principles', label: 'Quality Principles' },
];
...
function AssessmentForm({ onSubmit, isSubmitting }) {
  ...
  const sectionQuestions = QUESTIONS.filter((q) => {
    ...
    if (currentSection === 2) return q.section === 'Quality Management Principles';
    return false;
  });
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-8 border border-gray-700">
      <h2 className="text-2xl font-bold text-white mb-2">ISO 9001 Readiness Checker</h2>
      <p className="text-sm text-gray-400 mb-6">
        Assess your organization against ISO 9001:2015. Answer each question honestly — your answers stay in your browser.
      </p>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleOrgChange}
                className="w-full bg-gray-700 text-white px-4 py-2 rounded-md border border-gray-600 focus:border-purple-500 focus:outline-none"
                placeholder="e.g. Manufacturing, Healthcare, IT Services (optional)"
              />
            </div>
