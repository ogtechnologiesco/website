...
import { getRelatedInsights } from '../data/insightsPosts';

export default function RelatedInsights({ currentLink, categories }) {
  const related = getRelatedInsights(currentLink, categories);
